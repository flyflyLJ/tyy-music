...
import com.tyy.ss.search.entity.kugou.KuGouMusicBase;
import com.tyy.ss.search.entity.kugou.KuGouMusicUrl;
import com.tyy.ss.search.entity.vo.SearchRequestVo;
import com.tyy.ss.search.musicEnum.MusicSourceEnum;
import com.tyy.ss.search.service.KuGouMusicService;
...
public class KuGouMusicServiceImpl implements KuGouMusicService {
    ...
    public List<Music> findMusicByPage(SearchRequestVo req) {
        ...
        List<KuGouMusicBase.DataBean.ListsBean> lists = kuGouMusicBase.getData().getLists();
        String emptyKey = "00000000000000000000000000000000";
        for (KuGouMusicBase.DataBean.ListsBean song : lists) {
