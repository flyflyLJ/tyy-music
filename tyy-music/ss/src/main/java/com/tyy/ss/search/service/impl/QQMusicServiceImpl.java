...
import com.tyy.ss.search.entity.QQ.QQLyr;
import com.tyy.ss.search.entity.QQ.QQMusicBase;
import com.tyy.ss.search.entity.QQ.*;
import com.tyy.ss.search.entity.QQ.QQMusicUrl;
import com.tyy.ss.search.entity.vo.SearchRequestVo;
import com.tyy.ss.search.musicEnum.MusicSourceEnum;
import com.tyy.ss.search.service.QQMusicService;
...
public class QQMusicServiceImpl implements QQMusicService {
    ...
    public List<Music> findMusicByPage(SearchRequestVo req) {
        ...
        List<QQMusicBase.DataBean.SongBean.ListBean> songs = qqMusicBase.getData().getSong().getList();
        for (QQMusicBase.DataBean.SongBean.ListBean song : songs) {
            Music music = new Music();
            /** 设置歌名 */
            music.setName(song.getSongname());
            /** 获取歌手 */
            List<QQMusicBase.DataBean.SongBean.ListBean.SingerBean> singers = song.getSinger();
            String artist = "";
